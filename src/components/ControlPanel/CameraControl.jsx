...
export const CameraControl = () => {
  const { isLoading, isCameraActive, setIsCameraActive, setVideoUrl, setIsProcessing } = usePoseStore()
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow-sm">
      ...
      {!isCameraActive ? (
        <button className="control-button control-button-primary w-full justify-center text-sm py-2" onClick={startCamera} disabled={isLoading}>
          <i className="fa fa-video-camera"></i>
          <span>Start</span>
        </button>
      ) : (
        <button className="control-button control-button-secondary w-full justify-center text-sm py-2" onClick={stopCamera}>
